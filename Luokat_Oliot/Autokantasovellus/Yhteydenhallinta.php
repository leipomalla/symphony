...
class YhteydenHallinta
{
    ...
    private function avaaYhteys()
    {
        ...
        $ajuri = $init['autot']['ajuri'];
        $palvelin = $init['autot']['palvelin'];
        $portti = $init['autot']['portti'];
        $kanta = $init['autot']['kanta'];
        $kayttaja = $init['autot']['kayttaja'];
        $salasana = $init['autot']['salasana'];
